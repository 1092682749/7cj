...
@Injectable()
export class ClassianagementService {
    ...
    getsave(params): Observable<any> {
        return this.http.post(ROOT_URL + '/category/add', params)
            .map(this.extractData)
            .catch(this.handleError);
    }
    // 标签列表
    ...
    deleteClass(params): Observable<any> {
        return this.http.get(ROOT_URL + '/category/delete', {params})
            .map(this.extractData)
            .catch(this.handleError);
    }
